...
<div id="container">
        ...
        <div id="menu">
            <ul>
                ...
                <li class="menuitem"><a href="chapter1.php">Chapter 1</a></li>
                <li class="menuitem"><a href="chapter2.php">Chapter 2</a></li>
       ...
       <div id="leftmenu">
        ...
        <div id="content_main">
            <h1>Activity 6</h1>
            <h2>Define and explain types of PHP Data Types.
</p></h2>
