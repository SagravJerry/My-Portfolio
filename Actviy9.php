...
<div id="container">
       ...
       <div id="leftmenu">
        ...
        <div id="content_main">
            <h1>Activity 9</h1>
            <h2>Arithmetic Operations Activity
</p></h2>
               <a href="ArithmeticOperator/index.php" ><h2>Arithmetic Operation</a>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
        <center> <img src="images/act6.png" width ="80%"></center>
 <h2>Arithmetic Screenshots</h2><br>
        <img src="images/act7.png" width ="80%">
        <img src="images/act8.png" width ="80%">
        <img src="images/act9.png" width ="80%">
        <img src="images/act10.png" width ="80%">
        <img src="images/act11.png" width ="80%">
        <img src="images/act12.png" width ="80%">
